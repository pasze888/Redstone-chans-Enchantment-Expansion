...
public final class ModEnchantmentEffectComponents {
    ...
    /** 狂战士（berserk）：每损失 10% 生命的伤害加成比例（每级） */
    public static final DeferredHolder<DataComponentType<?>, DataComponentType<List<ConditionalEffect<EnchantmentValueEffect>>>> BERSERK_DAMAGE_BONUS =
            value("berserk_damage_bonus");
    ...
    public static final DeferredHolder<DataComponentType<?>, DataComponentType<Unit>> PEGASUS =
            unit("pegasus");
    /** 狼群领袖（pack_leader）：每级每只同伴狼的伤害加成比例（实际 50% × 等级） */
    ...
    public static final DeferredHolder<DataComponentType<?>, DataComponentType<List<ConditionalEffect<EnchantmentValueEffect>>>> SNIPE_BONUS =
            value("snipe_bonus");
    /** 精神（spirit）：夜晚移动速度加成比例（每级） */
    public static final DeferredHolder<DataComponentType<?>, DataComponentType<List<ConditionalEffect<EnchantmentValueEffect>>>> SPIRIT_SPEED_BONUS =
            value("spirit_speed_bonus");
